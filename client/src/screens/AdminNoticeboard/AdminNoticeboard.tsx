        ...
        <div className="page-wrapper">
            <div className="mb-8">
                ...
                <p className="section-subheading">
                    Publish announcements visible on the home page
                </p>
            </div>
                ...
                <div className="card-md">
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            ...
                            {imagePreview ? (
                                <div
                                    className="relative h-32 rounded-xl overflow-hidden border border-slate-200 cursor-pointer"
                                ...
                                <button
                                    ...
                                    type="button"
                                    onClick={() => fileRef.current?.click()}
                                    className="w-full h-24 border-2 border-dashed border-slate-200 rounded-xl flex items-center justify-center gap-2 text-slate-400 hover:border-emerald-400 hover:text-emerald-600 transition-colors"
                                >
                    ...
                    {isLoading ? (
                        ...
                        <div className="space-y-3">
                            {notices.map((n) => (
                                <div
                                    key={n.id}
                                    className={`card py-4 ${!n.isActive ? "opacity-60" : ""}`}
                                >
                                    <div className="flex items-start justify-between gap-3">
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <div className="flex items-center gap-2 mb-1">
                                                ...
                                                <span
                                                    className={`badge ${n.isActive ? "badge-approved" : "badge-pending"} shrink-0`}
                                                >
                                                    {n.isActive
                                                        ? "Active"
                                                        : "Hidden"}
