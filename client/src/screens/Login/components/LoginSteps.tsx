    ...
    <div className="animate-fade-in space-y-6">
      <div className="text-center space-y-1.5">
        ...
        <p className="text-slate-500 text-sm leading-relaxed max-w-xs mx-auto">
          Enter your mobile number to receive a verification code on WhatsApp
        </p>
      </div>

      <div className="space-y-1.5">
        <label htmlFor="phone-input" className="block text-xs font-bold uppercase tracking-wider text-slate-600">
          Mobile Number
        </label>
        <div
        ...
        {phoneError && <p className="text-red-500 text-xs font-medium pl-1">{phoneError}</p>}
      </div>
      ...
      <div className="text-center pt-1">
        {resendTimer > 0 ? (
          <p className="text-xs text-slate-500 flex items-center justify-center gap-1.5">
            ...
            <span className="font-bold text-emerald-700 font-mono">{resendTimer}s</span>
          </p>
        ) : (
          <button
