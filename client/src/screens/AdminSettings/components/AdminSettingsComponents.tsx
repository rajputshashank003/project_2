            ...
            <div className="space-y-4">
                ...
                <div>
                    ...
                    <textarea
                        ...
                        value={form.vision || ""}
                        onChange={(e) =>
                            handleFormChange("vision", e.target.value)
                        }
                        className="form-input resize-none"
                    />
                </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input
                        ...
                        onChange={(e) =>
                            handleFormChange("presidentName", e.target.value)
                        }
                        className="form-input"
                    />
                </div>
                <div>
                    ...
                    <input
                        ...
                        onChange={(e) =>
                            handleFormChange("secretaryName", e.target.value)
                        }
                        className="form-input"
                    />
                </div>
...
export const ContactSettingsForm: React.FC = () => {
    ...
    return (
        <div className="card-md space-y-4">
            ...
            <div>
                <label className="form-label">
                    Manager Phone Number (for Instant WhatsApp Alerts)
                </label>
                <input
                    ...
                    onChange={(e) =>
                        handleFormChange("managerPhone", e.target.value)
                    }
                    className="form-input"
                />
                <p className="text-xs text-slate-500 mt-1">
                    When a user requests a donation verification or volunteer ID
                    card, an instant alert will be sent to this WhatsApp number
                    with the applicant details and review link.
                </p>
            </div>

            <div>
                <label className="form-label">
                    Office Address * (Printed on ID Card Back & Footer)
                </label>
                <textarea
                    id="setting-address"
                    rows={2}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input
                        ...
                        value={form.upiId}
                        onChange={(e) =>
                            handleFormChange("upiId", e.target.value)
                        }
                ...
                <div>
                    ...
                    <input
                        ...
                        value={form.upiName}
                        onChange={(e) =>
                            handleFormChange("upiName", e.target.value)
                        }
                        className="form-input"
                    />
                </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div>
                    ...
                    <input
                        ...
                        onChange={(e) =>
                            handleFormChange("statVolunteers", e.target.value)
                        }
                        className="form-input"
                    />
                </div>
                <div>
                    ...
                    <input
                        ...
                        onChange={(e) =>
                            handleFormChange("statEventsHeld", e.target.value)
                        }
                        className="form-input"
                    />
                </div>
                <div>
                    ...
                    <input
                        ...
                        onChange={(e) =>
                            handleFormChange("statDonations", e.target.value)
                        }
                        className="form-input"
                    />
                </div>
                <div>
                    ...
                    <input
                        ...
                        onChange={(e) =>
                            handleFormChange("statYearsActive", e.target.value)
                        }
                        className="form-input"
                    />
                </div>
                        ...
                        {logoPreview ? (
                            <React.Fragment>
                                <img
                                    src={logoPreview}
                                    alt="NGO Logo"
                                    className="h-14 w-14 object-contain bg-white rounded-lg p-1 border"
                                />
