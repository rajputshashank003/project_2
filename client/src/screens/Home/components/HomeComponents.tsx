            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                <div className="flex flex-col md:flex-row items-center gap-6 md:gap-8 min-h-[300px] md:min-h-[200px] justify-center">
                    ...
                    <div className="flex-1 min-w-0 flex flex-col justify-center py-2 min-h-[110px] md:min-h-0">
                        ...
                        <h2 className="text-xl sm:text-2xl font-bold mb-2 leading-tight break-words line-clamp-2">
                            {active.title}
                        </h2>
                        <p className="text-emerald-100 text-sm sm:text-base leading-relaxed break-words line-clamp-3">
                            {active.content}
                        </p>
                    </div>
                </div>
        ...
        <section className="relative bg-gradient-to-br from-emerald-50 via-white to-emerald-50 py-20 sm:py-28 overflow-hidden">
            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                ...
                <p className="text-lg text-slate-500 max-w-2xl mx-auto mb-10 leading-relaxed">
                    Join {ngoConfig.name} in making a meaningful difference.
                    Every donation, every volunteer matters.
                </p>
                ...
                <div className="mt-16 grid grid-cols-2 sm:grid-cols-4 gap-6 max-w-3xl mx-auto">
                    {[
                        ...
                        },
                        {
                            ...
                            value: ngoConfig.statDonations || "₹50L+",
                        },
                        {
...
const GalleryImageCard: React.FC<{ imageUrl: string; caption?: string }> = ({
    imageUrl,
    caption,
}) => {
        ...
        <section className="py-16 sm:py-20 bg-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-12">
                    ...
                    <p className="section-subheading text-base">
                        Moments from our journey of service and compassion
                    </p>
                </div>
                ...
                {isLoading ? (
                    <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                        {[1, 2, 3, 4, 5, 6].map((n) => (
                            <div
                                key={n}
                                className="rounded-2xl aspect-square bg-slate-100 animate-pulse flex items-center justify-center"
                            >
    ...
    <section className="bg-emerald-700 py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-emerald-100 text-lg mb-8 max-w-xl mx-auto">
                Get your official volunteer ID card and join our mission to
                create lasting change in communities.
            </p>
            <Link
                to="/id-generate"
                className="inline-flex items-center gap-2 bg-white text-emerald-700 font-bold px-8 py-3 rounded-xl hover:bg-emerald-50 transition-colors text-base"
            >
                Apply for ID Card
