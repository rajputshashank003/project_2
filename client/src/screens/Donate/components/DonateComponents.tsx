    ...
    return (
        <div className="card-md mb-6">
            ...
            <p className="text-xs text-slate-400 mt-2">
                Open any UPI app or Bank app → Transfer funds → Upload payment
                screenshot below
            </p>
        </div>
    );
        ...
        <div className="card-md">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
                <div>
                    ...
                    <input
                        ...
                        onChange={(e) =>
                            handleFormChange("donorName", e.target.value)
                        }
                ...
                <div className="flex flex-wrap gap-2 mb-2">
                    {QUICK_AMOUNTS.map((amt) => (
                        <button
                            ...
                            type="button"
                            onClick={() =>
                                handleFormChange("amount", String(amt))
                            }
            ...
            <div className="mb-6">
                ...
                {screenshotPreview ? (
                    ...
                    >
                        <Upload
                            className={`h-6 w-6 ${errors.screenshot ? "text-red-400" : "text-slate-400"}`}
                        />
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm">
            <div className="bg-white rounded-3xl shadow-card-lg p-8 max-w-md w-full text-center animate-slide-up">
                ...
                <p className="text-slate-500 mb-3">
                    Thank you for your generous contribution. Our admin will
                    verify your payment and issue your certificate shortly.
                </p>
                ...
                <p className="text-xs text-slate-400 mb-6">
                    You'll receive SMS & email notifications once verified.
                </p>
