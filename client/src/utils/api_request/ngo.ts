...
export const updateNgoConfig = async (
    ...
    if (data.logoFile || data.signatureFile) {
        ...
        if (data.registrationNumber !== undefined) formData.append('registrationNumber', data.registrationNumber);
        if (data.upiId !== undefined) formData.append('upiId', data.upiId);
        if (data.upiName !== undefined) formData.append('upiName', data.upiName);
        ...
        if (data.accountHolderName !== undefined) formData.append('accountHolderName', data.accountHolderName);
        if (data.presidentName !== undefined) formData.append('presidentName', data.presidentName);
        if (data.secretaryName !== undefined) formData.append('secretaryName', data.secretaryName);
        if (data.foundedYear !== undefined) formData.append('foundedYear', String(data.foundedYear));
        ...
        if (data.managerPhone !== undefined) formData.append('managerPhone', data.managerPhone);
        if (data.statBeneficiaries !== undefined) formData.append('statBeneficiaries', data.statBeneficiaries);
        if (data.statVolunteers !== undefined) formData.append('statVolunteers', data.statVolunteers);
        if (data.statEventsHeld !== undefined) formData.append('statEventsHeld', data.statEventsHeld);
        if (data.statDonations !== undefined) formData.append('statDonations', data.statDonations);
        if (data.statYearsActive !== undefined) formData.append('statYearsActive', data.statYearsActive);
