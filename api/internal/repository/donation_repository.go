...
// ListPaginated returns paginated donations ordered by requested_at DESC with optional status, search, and date filters.
func (r *DonationRepository) ListPaginated(offset, limit int, status, search, startDate, endDate string) ([]models.Donation, int64, error) {
